    ...
    return (
        <div className="group flex flex-row mb-4 p-5 transition-all bg-background hover:bg-surface-200">
            ...
            <div className='basis-3/4 flex flex-col'>
                <Link href={props.href} target="_blank" rel="noopener noreferrer" className='font-medium transition-all'>{props.position} at {props.event}</Link>
                <Link href={props.href} target="_blank" rel="noopener noreferrer" className='text-surface-600 mb-4 flex flex-row items-center'>
